...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		function reloadPage(path, order, func) {
			var param = 'path=' + path + '&map=' + order + '&dir=' + dirName;
 ...
 *   since many of the settings need to be passed to Flash in map to take
 *   effect.
 * *********************** */
...
/* *******************************
	...
	This ensures that events are executed in a determinate map and that
...
// we must queue them in map to garentee that they are executed in map.
